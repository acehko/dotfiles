...
local function lsp_keymaps(bufnr)
  ...
  -- vim.api.nvim_buf_set_keymap(bufnr, 'n', '<C-[>', ':Telescope lsp_references<CR>', opts)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '[e', ':lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', opts)
  vim.api.nvim_buf_set_keymap(bufnr, 'n', 'ge', ':lua vim.diagnostic.open_float()<CR>', opts)
  vim.api.nvim_buf_set_keymap(bufnr, 'n', ']e', ':lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>e', ':lua vim.diagnostic.setloclist()<CR>', opts)
